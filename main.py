...
# This will open up the local page running the program
...
# Compute/Display the image and key
def computeImage():
...
# Clear the image and key
def clearImage():
    div_image.text = ""
    div_key.text = ""

# Tie together callbacks
